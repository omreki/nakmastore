    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'glow': '0 0 40px rgba(255, 0, 127, 0.3)',
            ...
            backgroundImage: {
                ...
                'confirmation-gradient': 'radial-gradient(circle at 50% -20%, #ff007f 0%, #1e0c42 40%, #000000 100%)',
                ...
                'gradient-mesh': 'radial-gradient(at 50% 0%, rgba(255, 0, 127, 0.25) 0px, transparent 70%), radial-gradient(at 100% 0%, rgba(48, 19, 106, 1) 0px, transparent 50%), radial-gradient(at 90% 90%, rgba(216, 105, 40, 0.15) 0px, transparent 60%), radial-gradient(at 0% 100%, rgba(30, 13, 106, 1) 0px, transparent 50%)',
