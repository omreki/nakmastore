export default {
    ...
    theme: {
        extend: {
            colors: {
                "primary": "#b82063",
                "primary-hover": "#a01b56",
                "primary-light": "#d44a86",
                "primary-dark": "#7a1542",
                "primary-bright": "#b82063",
                "primary-accent": "#d86928",
                "accent": "#d86928",
                "secondary": "#30136a",
                "background-light": "#4a2da0",
                "background-dark": "#1e0c42",
                "card-dark": "rgba(48, 19, 106, 0.6)",
                "text-main": "#ffffff",
                "text-muted": "#94a3b8",
                "surface": "#ffffff",
                "surface-dark": "#30136a",
                "surface-highlight": "#4a2da0",
                "surface-solid": "#ffffff",
                "surface-white": "#ffffff",
                "surface-light": "rgba(255, 255, 255, 0.6)",
                "surface-hover": "rgba(184, 32, 99, 0.1)",
