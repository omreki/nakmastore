...
const LoginPage = () => {
    ...
    return (
        <div className="glossy-bg min-h-screen flex flex-col font-display text-white antialiased selection:bg-[#30136a] selection:text-white relative overflow-x-hidden">
            ...
            <div className="flex-1 flex items-center justify-center p-4 pt-24 md:pt-20 lg:p-8 z-10">
                <div className="w-full max-w-[1200px] min-h-[600px] md:min-h-[700px] glass-card shadow-gloss rounded-[2rem] md:rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <div className="relative w-full lg:w-1/2 h-64 lg:h-auto overflow-hidden bg-[#1e0c42] group">
                        ...
                        ></div>
                        <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#1e0c42] via-[#30136a]/40 to-transparent"></div>
                    ...
                    <div className="w-full lg:w-1/2 p-6 md:p-8 lg:p-16 flex flex-col justify-center relative bg-gradient-to-br from-white/[0.03] to-transparent">
                        ...
                        <div className="max-w-[420px] mx-auto w-full">
                            <div className="text-center mb-8">
                                ...
                                {error && (
                                    <div className={`mt-4 p-3 rounded-2xl text-xs font-bold uppercase tracking-widest ${error.includes('successful') ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-[#30136a]/20 text-[#4a2da0] border border-[#30136a]/30'}`}>
                                        {error}
                                    </div>
                                )}
                            </div>
                            ...
                            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                                ...
                                {isLogin && (
                                    <div className="flex items-center justify-between px-1">
                                        ...
                                        <Link to="#" className="text-xs font-semibold text-primary hover:text-[#4a2da0] hover:underline transition-colors">Forgot Password?</Link>
                                    </div>
                                )}

                                <button
                                    className={`mt-2 w-full h-12 bg-primary hover:bg-[#1e0c42] text-white rounded-full font-bold text-sm tracking-wide shadow-[0_0_20px_-5px_rgba(5,150,105,0.5)] transition-all hover:shadow-[0_0_25px_-5px_rgba(5,150,105,0.7)] active:scale-[0.98] flex items-center justify-center gap-2 group ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                                    type="submit"
                                    disabled={loading}
                                >
                            ...
                            <div className="mt-8 text-center">
                                <p className="text-sm text-gray-500">
                                    ...
                                    <button onClick={() => setIsLogin(!isLogin)} className="font-bold text-primary hover:underline hover:text-[#4a2da0] ml-1">
