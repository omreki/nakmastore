...
const LoginPage = () => {
    ...
    return (
        <div className="glossy-bg min-h-screen flex flex-col font-display text-white antialiased selection:bg-black selection:text-white relative overflow-x-hidden">
            ...
            <div className="flex-1 flex items-center justify-center p-4 pt-24 md:pt-20 lg:p-8 z-10">
                <div className="w-full max-w-[1200px] min-h-[600px] md:min-h-[700px] glass-card shadow-gloss rounded-[2rem] md:rounded-[2.5rem] overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <div className="relative w-full lg:w-1/2 h-64 lg:h-auto overflow-hidden bg-black group">
                        <div
                    ...
                    <div className="w-full lg:w-1/2 p-6 md:p-8 lg:p-16 flex flex-col justify-center relative bg-gradient-to-br from-white/[0.03] to-transparent">
                        ...
                        <div className="max-w-[420px] mx-auto w-full">
                            ...
                            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                                ...
                                <button
                                    className={`mt-2 w-full h-12 bg-primary hover:bg-black text-white rounded-full font-bold text-sm tracking-wide shadow-[0_0_20px_-5px_rgba(5,150,105,0.5)] transition-all hover:shadow-[0_0_25px_-5px_rgba(5,150,105,0.7)] active:scale-[0.98] flex items-center justify-center gap-2 group ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                                    type="submit"
                                    disabled={loading}
                                >
