    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] pt-24 md:pt-32 pb-24">
            <SEO
                ...
                description={`Privacy Policy for ${settings.storeName}. Learn how we handle your data.`}
            />
            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="mb-16">
                    ...
                    <h1 className="text-white text-4xl md:text-7xl font-black leading-tight tracking-[-0.04em]">
                        Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-400 to-gray-600">Policy</span>
                    </h1>
                    <p className="text-gray-500 text-lg font-medium mt-6 max-w-2xl leading-relaxed">
                        Our commitment to data integrity and user sovereignty. This document outlines the parameters of data collection and processing.
                    </p>
                </div>
                ...
                <div className="glossy-panel rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-12 border border-white/5 bg-black/20 shadow-2xl relative overflow-hidden">
                    ...
                    <div
                        ...
                        dangerouslySetInnerHTML={{ __html: settings.privacyPolicy || '<p>Privacy policy content is being updated.</p>' }}
                    />
                </div>
