                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="glass-panel rounded-2xl p-6 md:p-8 sticky top-24">
                            ...
                            <div className="mt-8 flex flex-col gap-3">
                                <Link to="/account" className="flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary to-[#7a1542] px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/40 border border-white/10 transition-transform hover:scale-[1.02] active:scale-[0.98]">
