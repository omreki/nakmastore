            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="mb-16">
                    ...
                    <h1 className="text-white text-4xl md:text-7xl font-black leading-tight tracking-[-0.04em]">
                        Size <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-400 to-gray-600">Guide</span>
                    </h1>
                    <p className="text-gray-500 text-lg font-medium mt-6 max-w-2xl leading-relaxed">
                        Engineered for precision fit. Calibrate your selection with our comprehensive sizing matrix.
                    </p>
                </div>
                ...
                <div className="glossy-panel rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-12 border border-white/5 bg-black/20 shadow-2xl relative overflow-hidden">
                    ...
                    <div
                        ...
                        dangerouslySetInnerHTML={{ __html: settings.sizeGuide || '<p>Size guide content is being updated.</p>' }}
                    />
                </div>
                ...
                <style>{`
                    ...
                    .policy-content table { width: 100%; border-collapse: collapse; margin: 1.5rem 0; border: 1px solid rgba(255,255,255,0.1); }
                    .policy-content th, .policy-content td { border: 1px solid rgba(255,255,255,0.1); padding: 0.75rem; text-align: left; }
                    .policy-content th { background: rgba(255,255,255,0.05); color: white; font-weight: 700; }
                `}</style>
