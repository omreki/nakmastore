...
const WomenPage = () => {
    ...
    const [pageContent, setPageContent] = useState({
        ...
        hero_title: "SCULPTED MOTION",
        hero_subtitle: "Elegance in movement. Engineered for the modern athlete who demands both style and substance.",
        ...
        try {
            ...
            if (pageData) {
                setPageContent({
                    ...
                    hero_title: pageData.hero_title || "SCULPTED MOTION",
                    hero_subtitle: pageData.hero_subtitle || "Elegance in movement. Engineered for the modern athlete who demands both style and substance.",
    ...
    return (
        <div className="bg-[#050505] min-h-screen text-white font-['Manrope'] pt-20 md:pt-24 pb-20">
            <SEO
                title="Women's Collection"
                description="Elegance in movement. Engineered for the modern athlete who demands both style and substance."
            />
            {/* Header / Hero Section */}
            <div className="w-full px-4 md:px-6 max-w-[1600px] mx-auto mb-12 md:mb-16">
                <div className="relative w-full h-[300px] md:h-[500px] rounded-[32px] md:rounded-[40px] overflow-hidden group shadow-2xl">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-16">
                        <span className="text-primary-light text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] mb-4 text-[#a14550]">{pageContent.hero_title}</span>
                ...
                <div className="flex items-center gap-3 overflow-x-visible pb-2 md:pb-0 scrollbar-hide relative">
                    ...
                    {hiddenSubCategories.length > 0 && (
                        <div className="relative">
                            ...
                            {isMoreOpen && (
                                <div className="absolute top-full left-0 mt-2 w-48 bg-[#0a0a0a] border border-white/10 rounded-2xl p-2 shadow-2xl z-50">
