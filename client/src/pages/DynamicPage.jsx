            ...
            <div className="w-full px-4 md:px-6 max-w-[1600px] mx-auto mb-12 md:mb-16">
                <div className="relative w-full h-[300px] md:h-[500px] rounded-[32px] md:rounded-[40px] overflow-hidden group shadow-2xl">
                    <div
                        ...
                        style={{ backgroundImage: pageData?.hero_image_url ? `url(${pageData.hero_image_url})` : 'none', backgroundColor: '#1a1a1a' }}
                    >
                    </div>
                                        ...
                                        <div className="relative aspect-[4/5] rounded-[32px] overflow-hidden mb-6 bg-[#1a1a1a] transition-transform duration-500 group-hover:-translate-y-2">
                                            ...
                                            {(product.is_new || product.is_sale) && (
                                                <div className="absolute top-6 left-6">
                                                    <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${product.is_new ? 'bg-black text-white' : 'bg-[#b82063] text-white'}`}>
