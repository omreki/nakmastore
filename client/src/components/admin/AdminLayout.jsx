...
const AdminLayout = ({ children }) => {
    ...
    return (
        <div className="bg-[#050505] text-white font-display selection:bg-primary/50 min-h-screen flex">
            {/* Background Effects */}
            <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-b from-[#1a0507] via-[#050505] to-[#000000]"></div>
                ...
                <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-gradient-to-tr from-[#a14550]/10 to-transparent rounded-full blur-[100px] mix-blend-screen"></div>
                <div className="absolute top-[40%] left-[30%] w-[400px] h-[400px] bg-blue-900/10 rounded-full blur-[90px] mix-blend-screen"></div>
            </div>
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-50 flex lg:hidden">
                    ...
                    ></div>
                    <div className="relative w-72 h-full bg-[#050505] border-r border-white/5 shadow-2xl animate-slide-in-left flex flex-col">
